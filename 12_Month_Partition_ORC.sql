...
create table gnrl_pay_month_partition_orc(
Change_Type string, 
...
Recipient_Country string) partitioned by (Payment_Year string, Payment_Month int) clustered by (Recipient_Country) into 1 buckets stored as orc;




insert overwrite table gnrl_pay_month_partition_orc partition(Payment_Year, Payment_Month) 
select 
Change_Type, 
