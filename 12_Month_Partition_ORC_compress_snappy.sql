...
create table gnrl_pay_orc_test_compressed_snappy(
Change_Type string, 
...
Recipient_Country string) partitioned by (Payment_Year string, Payment_Month int) clustered by (Recipient_Country) into 1 buckets stored as orc tblproperties("orc.compress"="SNAPPY");




insert overwrite table gnrl_pay_orc_test_compressed_snappy partition(Payment_Year, Payment_Month) 
select 
Change_Type, 
